    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-200/80 relative" dir="rtl">
      ...
      >
        ...
        >
          ...
          {/* Header Area (رأس الصفحة القابل للتعديل) */}
          <div className="border-b border-slate-200 pb-2 mb-6 flex items-center justify-between text-xs text-slate-400 select-none z-10 relative group">
            {isEditingHeader ? (
              <div className="flex items-center gap-1.5 flex-1">
                <input
                  ...
                  autoFocus
                  className="w-full text-xs font-bold text-blue-900 bg-blue-50 border border-blue-400 rounded px-2 py-0.5 focus:outline-none"
                />
                <button
              ...
              <div 
                ...
                className="flex items-center gap-2 cursor-pointer hover:bg-blue-50/70 p-1 rounded transition"
                title="انقر نقراً مزدوجاً لتعديل رأس الصفحة"
              >
                <span className="font-semibold text-slate-600">{docState.headerText}</span>
          ...
          <div className="border-t border-slate-200 pt-3 mt-8 flex items-center justify-between text-xs text-slate-500 select-none z-10 relative group">
            {isEditingFooter ? (
              <div className="flex items-center gap-1.5 flex-1">
                <input
                  type="text"
                  ...
                  autoFocus
                  className="w-full text-xs text-slate-800 bg-slate-50 border border-slate-400 rounded px-2 py-0.5 focus:outline-none"
                />
                <button
              ...
              <div 
                ...
                className="flex items-center gap-2 cursor-pointer hover:bg-blue-50/70 p-1 rounded transition"
                title="انقر نقراً مزدوجاً لتعديل تذييل الصفحة"
              >
                <span className="text-[11px] text-slate-500">{docState.footerText}</span>
                <Edit2 className="w-3 h-3 text-slate-400 opacity-0 group-hover:opacity-100 transition" />
              </div>
            )}
